...
/// <summary>
/// <c>promotion.discount.changed.v1</c> — a past-tense fact, broadcast (COM-007).
/// </summary>
/// <remarks>
...
/// (COM-008). Consumers are tolerant readers: an added field must be ignored, not rejected
/// (REL-005).
/// </remarks>
public sealed record DiscountChangedV1
{
    ...
    // COM-006 — the envelope every message carries.
    ...
    /// <summary>Present when <see cref="Outcome"/> is Applied. Integer minor units (TXN-006).</summary>
